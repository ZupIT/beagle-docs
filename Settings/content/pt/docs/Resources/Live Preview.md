...
title: "Live Preview"
description: >
  Nesta seção, você encontra informações sobre a funcionalidade do Live Preview e como configura-lo
---
...
![](../.gitbook/assets/livepreviewpluginintellijidea.gif)
...
{% tabs %}
{% tab title="Cliente Android" %}
### Passo 1: Instalar o submódulo

Para realizar a instalação, seu arquivo de `gradle` deve conter o fragmento abaixo:   
  
A versão atual do Beagle :[![https://img.shields.io/bintray/v/zupit/repo/beagle](https://raster.shields.io/bintray/v/zupit/repo/beagle)]()
