...
* [**Angular** ](beagle-web#angular)
* [**React** ](beagle-web#react)
...
{{% alert color="success" %}}
Parabéns, a sua biblioteca está instalada! Veja agora [**como usar o Beagle no Angular**](../../../../usando-beagle/web/angular)
{{% /alert %}}
...
{{% alert color="success" %}}
Parabéns, a sua biblioteca está instalada! Veja agora [**como usar Beagle no React.**](../../../usando-beagle/web/react)
{{% /alert %}}
...
👉 Se quiser ir direto para prática, acesse nosso[ **tutorial para criar um projeto do zero**](../criando-projeto-do-zero/case-web)
