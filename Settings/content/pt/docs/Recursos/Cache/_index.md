...
* [**Configurando o cache**](/pt/docs/recursos/cache/configurando-o-cache#configurando-e-customizando-o-cache) 
...
👉 Veja como fazer as [**configurações de cache**](/pt/docs/recursos/cache/configurando-o-cache#configurando-e-customizando-o-cache) de acordo com cada plataforma \(Android, iOS, Web e Backend\). 

👉Confira o [**funcionamento do cache**](/pt/docs/recursos/cache/configurando-o-cache#como-funciona-o-cache) de acordo com seus tipos \(confiável e não confiável\)
