...
No entanto, a sua aplicação pode precisar de componentes mais especializados \(Custom Views\) e, para torná-los _"_visíveis"  ao Beagle, você precisa criar um **widget específico** para ele. Dessa forma, você pode criar quantos novos componentes desejar, desde que sempre **torne as Views do seu aplicativo** _**"**_**visíveis" para o Beagle.**

## Como criar componentes \(custom views\) e widgets?

No exemplo abaixo, será implementado um [**custom widget**](../beagle-para-ios/custom-widgets.md) e o componente que ele registrará. Esse componente será composto por um texto e dois botões dentro de um layout linear. 
