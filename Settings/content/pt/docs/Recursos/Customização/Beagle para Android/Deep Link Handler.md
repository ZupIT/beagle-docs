...
Agora você só precisa chamar a [**Action Navigate**](../../../api/acoes/navigate/) com o **método** [**OpenNativeRoute**](../../../api/acoes/navigate/opennativeroute.md) como o exemplo abaixo:
