...
[beagle]({{< relref "../../../_index.md" >}}) / [br.com.zup.beagle.android.action]({{< relref "../../_index.md" >}}) / [Navigate]({{< relref "../_index.md" >}}) / [OpenNativeRoute]({{< relref "_index.md" >}}) / [execute]({{< relref "execute.md" >}}) / 
