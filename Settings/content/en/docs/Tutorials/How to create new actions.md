...
On Beagle, it's possible to create a customized [**action**](../../../api/acoes/) from a `CustomAction`. 
...
4. Call the method created on BeagleConfig, that can be seen on this [**example**](../../get-started/criando-um-projeto-do-zero/).
