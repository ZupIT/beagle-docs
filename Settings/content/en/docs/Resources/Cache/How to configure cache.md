...
This implementation happens inside the class named [**AppBeagleConfig**](../../get-started/using-beagle/android.md#passo-2-criar-uma-classe-beagleconfig), meaning that it is inside the Beagle's configuration class. 
