...
RootView interface holds the reference of an activity or fragment, through the interface methods you have reference to context, life cycle, ViewModelStore and parent view id. 
