...
Uma função chamada [**SetContext**](../api/api-acoes/setcontext.md) é a responsável por atualizar os valores do componente contexto. Ela poderá ser chamada na tela se você quiser usar as informações que estiverem nesse contexto. 
...
![](../.gitbook/assets/screenshot_1594752619.png)
