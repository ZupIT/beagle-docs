...
* **strategy:** opcional.  Mostra qual [**estratégia de cache**](../../../cache/) deve ser usada para carregar uma view específica. E usará a configuração global caso não for especificado. 
