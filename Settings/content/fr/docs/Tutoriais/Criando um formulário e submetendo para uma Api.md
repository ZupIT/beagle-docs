...
Para este tutorial, iremos usar algumas [**ações**](../api/api-acoes/) e também APIs: 

**Actions**

* [**SetContext**](../api/api-acoes/setcontext.md)
* [**SendRequest**](../api/api-acoes/sendrequest.md)

**APIs**

* [**Context**](../api/contexto.md)
...
Neste exemplo, utilizamos o evento `onChange` do próprio TextInput que é chamado sempre que o usuário digita um texto novo no input. Dentro do onChange, existe um [**contexto implícito**](../api/contexto.md#contextos-implicitos) chamado `onChange` no qual o `value` é o último valor digitado pelo usuário. 
