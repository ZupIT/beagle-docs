...
Você pode conferir um **exemplo prático** de [**como testar o Beagle no Backend**](/pt/get-started/using-beagle/backend) ou componente Server-Driven para testar o BFF.
