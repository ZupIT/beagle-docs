...
{{% alert color="warning" %}}
É muito importante que você registre sua CustomBeagleNavigationController nas configurações de [**dependências do Beagle.**](/pt/resources/customization/beagle-for-ios/beagles-dependencies)
{{% /alert %}}
