...
{{% alert color="success" %}}
Para saber como registrar essa nova ação e ver exemplo de como usar [click aqui!](/pt/resources/customization/beagle-for-ios/custom-actions/simple-custom-action//).
{{% /alert %}}
