...
Esta propriedade determina a posição de um assume em tela e os seus valores `top, right, bottom, left` se comportam de acordo com o [**Position Type**](/pt/resources/posicionamento-de-componentes/positiontype) deste elemento.
