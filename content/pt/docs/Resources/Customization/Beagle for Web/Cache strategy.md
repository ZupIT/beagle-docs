...
O Beagle Web oferece algumas estratégias de cache, entre elas o [**protocolo de cache padrão do Beagle guiado pelo backend**](/pt/docs/resources/cache#como-o-protocolo-de-cache-funciona). 
...
Estratégia que implementa apenas no caso do [**protocolo de cache do Beagle**](/pt/docs/resources/cache#como-o-protocolo-de-cache-funciona). Isso significa que ela funciona igual à estratégia padrão, mas sem o fallback.
