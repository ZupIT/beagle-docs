...
No exemplo a seguir, são utilizados outros componentes para explicar o TabBar: o [**PageView**](/pt/docs/api/components/layout/pageview) e o [**Contexto**](/pt/docs/api/contexto/). 
