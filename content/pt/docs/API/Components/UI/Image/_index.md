...
| :--- | :--- | :---: | :--- |
| path | [**ImagePath**](/pt/docs/api/components/ui/image/imagepath) ou [**Binding**](/pt/docs/api/contexto#binding) | ✓ | Referência de uma imagem local ou url de uma imagem remota a ser exibida. |
