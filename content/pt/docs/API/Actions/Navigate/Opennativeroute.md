...
Para testar, é preciso configurar o [**Deep Link Handler**](/pt/docs/resources/customization/beagle-for-android/deep-link-handler) para Android  ou o **openNativeRoute,** no caso de aplicação iOS. Além disso, seu endpoint do BFF precisa retornar a tela do código abaixo e chamar esse endpoint no Frontend.
