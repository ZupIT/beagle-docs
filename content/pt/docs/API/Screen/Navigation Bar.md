...
| backButtonAccessibility | [**Accessibility**](/pt/docs/api/accessibility) |   | Informações de acessibilidade do backButton. |
...
| image | [**Image**](/pt/docs/api/components/ui/image/) |   | Imagem do item da barra. |
| action | [**Action**](/pt/docs/api/actions) | ✓ | Ação que deve ser realizada ao clicar no item da barra de navegação. |
| accessibility | [**Accessibility**](/pt/docs/api/accessibility) |   | Opções de acessibilidade para o navigation item. |
