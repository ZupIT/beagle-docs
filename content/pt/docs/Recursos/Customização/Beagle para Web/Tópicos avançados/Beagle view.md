...
* **strategy:** opcional.  Mostra qual [**estratégia de cache**](/pt/docs/recursos/customização/beagle-para-web/estratégias-de-cache/) deve ser usada para carregar uma view específica. E usará a configuração global caso não for especificado. 
