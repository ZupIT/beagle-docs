...
Uma das principais vantagens do Beagle é facilitar o desenvolvimento a partir do [**paradigma BFF.**](/pt/principais-conceitos#backend-for-frontend)
...
Sim! Por ser um **framework cross-platform,** Beagle te auxilia a desenvolver aplicações nestas três plataformas utilizando o [**conceito de Server-Driven UI,**](/pt/principais-conceitos#server-driven-ui) o que torna possível que um mesmo BFF seja utilizado para as 3 aplicações.

Você pode ver mais sobre como criar projetos no Beagle para as 3 plataformas em: 

* [**Beagle for Android** ](/pt/primeiros-passos/criando-um-projeto-do-zero/case-android/)
* [**Beagle for iOS**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-ios/)
* [**Beagle for Web**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-web)
