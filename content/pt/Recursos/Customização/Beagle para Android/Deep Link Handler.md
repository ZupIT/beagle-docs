...
Agora você só precisa chamar a [**Action Navigate**](/pt/api/ações/navigate/) com o método [**OpenNativeRoute**](/pt/api/ações/navigate/opennativeroute) como o exemplo abaixo:
