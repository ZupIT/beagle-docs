...
Você pode observar os estados e tratar os erros a partir do [`onServerDrivenContainerStateChanged()`](/pt/recursos/customização/beagle-para-android/carregamento-e-tratamento-de-erros)
