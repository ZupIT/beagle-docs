...
{{% alert color="warning" %}}
Se você não encontrou os arquivos `beagle-components.module.ts` ou `beagle.module.ts`, veja [**como configurar a biblioteca Beagle Web para o Angular**.](/pt/primeiros-passos/usando-o-beagle/web/angular)
{{% /alert %}}
{{% /tab %}}
...
Caso você não tenha este arquivo em seu projeto, veja [**como configurar a biblioteca Beagle Web para o React**](/pt/primeiros-passos/usando-o-beagle/web/react).
