...
Para entender melhor sobre renderização, recomendamos a leitura da seção [**estrutura de dados**](/pt/recursos/customização/beagle-para-web/tópicos-avançados/estrutura-de-dados).
