...
| strategy | string&lt;[**Estratégia de cache**](/pt/recursos/customização/beagle-para-web/estratégias-de-cache#tipos-de-estratégias)&gt; | Estratégia de cache adotada na requisição. |
