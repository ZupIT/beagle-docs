...
{{% alert color="info" %}}
Além dessas funcionalidades, alguns componentes possuem propriedades específicas como mudança na cor do texto ou alinhamento. Conheça mais sobre os [**componentes do Beagle**](/pt/api/componentes/)
{{% /alert %}}
