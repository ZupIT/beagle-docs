...
Esta classe mapeia os estilos de um aplicativo para que seja possível referenciá-los no [**BFF**](/pt/principais-conceitos#backend-for-frontend) ao construir uma tela [**Server-Driven**](/pt/principais-conceitos#server-driven-ui).
