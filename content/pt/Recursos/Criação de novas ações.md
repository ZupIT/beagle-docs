...
Chame o [**método criado no BeagleConfig**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-ios#passo-2-configurar-o-beagle), tal como no tutorial da seção [**"Criando um projeto do zero".** ](/pt/primeiros-passos/criando-um-projeto-do-zero/case-ios#iniciando-um-projeto-ios)
