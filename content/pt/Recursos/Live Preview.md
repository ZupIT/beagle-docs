...
* Usar o [**Beagle SDK**](/pt/primeiros-passos/instalando-o-beagle/backend) em seu BFF **;**
* Instalar o `BeaglePreview` plugin;

### Configuração do BFF

Você precisa que seu BFF esteja configurado com o Beagle para utilizar o Live Preview. Caso ainda não o tenha, faça o [**download de um projeto inicial pronto**](https://github.com/ZupIT/beagle-examples/tree/master/BeagleSampleBackend). Outra possibilidade que você pode fazer, é o nosso tutorial de [**como implementar um backend**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-backend) com o Beagle configurado.
...
Para realizar a instalação, é necessário primeiro já ter seguido os [**passos de instalação do Beagle para iOS**](/pt/primeiros-passos/instalando-o-beagle/ios). Assim os passos seguintes variam de acordo com o método utilizado.
