...
Para outras linguagens, seu servidor precisa servir o JSON seguindo nossa API. Veja a implementação de [**mecanismos específicos de cada linguagem**]({{< ref path="/resources/platform-sorting" lang="pt" >}}).
{{% /alert %}}
