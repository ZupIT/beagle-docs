...
- Para que seu Pull Requests ser aceito, siga as diretrizes de contribuição. [**saiba mais aqui**](https://github.com/ZupIT/beagle/blob/master/CONTRIBUTING.md).
...
- Para editar um conteúdo, basta navegar até a página a ser editada usando o menu lateral esquerdo ou a barra de pesquisa. Em seguida, clique no botão "Edit this page" localizado no menu lateral direito.
