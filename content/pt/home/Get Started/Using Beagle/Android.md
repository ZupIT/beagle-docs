...
Neste tutorial abaixo, vamos fazer a configuração e construir uma tela local. Para aprender como configurar e construir uma tela remota, siga no tutorial [**criando um projeto do zero**](/pt/home/get-started/creating-a-project-from-scratch/case-android)
...
{{% alert color="info" %}}
Você pode criar o Design System agora, mas neste momento é possível prosseguir com os próximos passos sem configurá-lo. Para saber mais, confira a seção sobre [**Design System com Beagle para Android**](/pt/home/get-started/creating-a-project-from-scratch/case-android/design-system-with-beagle-android).
{{% /alert %}}
...
Mesmo não sendo necessário neste momento, é bom ter em mente que você precisará [**configurar o ProGuard**](/pt/home/resources/customization/beagle-for-android/proguard-configuration) para ativar o ofuscamento do seu código quando estiver publicando releases.
