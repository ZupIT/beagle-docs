...
Para outras linguagens, seu servidor precisa servir o JSON seguindo nossa API. Dê uma olhada também na nossa implementação de [**cache**](/pt/home/resources/cache/) e em [**mecanismos específicos de cada linguagem**](/pt/home/resources/components/platform-sorting)
{{% /alert %}}
...
{{% alert color="warning" %}}
Se o seu time trabalha com microsserviços usando outros frameworks, acesse o [**framework do Beagle**](/pt/home/resources/customization/beagle-for-backend/beagle-framework).  
{{% /alert %}}
...
Você pode conferir um **exemplo prático** de tela ou componente Server-Driven [**para testar o BFF**](/pt/home/get-started/using-beagle/backend)
...
Você pode conferir um **exemplo prático** de [**como testar o Beagle no Backend**](/pt/home/get-started/using-beagle/backend) ou componente Server-Driven para testar o BFF.
...
👉Vá para as [**configurações iniciais**](/pt/home/get-started/using-beagle/backend) para habilitar uso do Beagle no seu projeto Backend

👉 Se quiser ir direto para prática, acesse nosso [**tutorial para criar um projeto do zero**](/pt/home/get-started/creating-a-project-from-scratch/case-backend)
