...
Uma das principais vantagens do Beagle é facilitar o desenvolvimento a partir do [**paradigma BFF.**](/pt/home/key-concepts#backend-for-frontend)
...
Sim! Por ser um **framework cross-platform,** Beagle te auxilia a desenvolver aplicações nestas três plataformas utilizando o [**conceito de Server-Driven UI,**](/pt/home/key-concepts#server-driven-ui) o que torna possível que um mesmo BFF seja utilizado para as 3 aplicações.
