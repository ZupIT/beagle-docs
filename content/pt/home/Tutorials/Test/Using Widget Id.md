...
O método Set Id é usado quando você precisa setar um Id no [**widget**](/pt/home/api/widget) fornecido para o [**BFF**](/pt/home/key-concepts#backend-for-frontend). Para fazer isso, você precisa chamar esse método no widget que você quer o Id setado durante o momento que você está criando o seu widget.
