...
| backButtonAccessibility | [**Accessibility**](/pt/api/acessibilidade) |   | Informações de acessibilidade do backButton. |
...
| image | [**Image**](/pt/api/componentes/ui/image/) |   | Imagem do item da barra. |
| action | [**Action**](/pt/api/ações) | ✓ | Ação que deve ser realizada ao clicar no item da barra de navegação. |
| accessibility | [**Accessibility**](/pt/api/acessibilidade) |   | Opções de acessibilidade para o navigation item. |
