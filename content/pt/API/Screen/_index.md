...
| child                  | [**Server Driven Component**](/pt/api/components/)      |      ✓      | Define os elementos na tela. Pode ser qualquer componente visual que estenda de `ServerDrivenComponent`.     |
...
| context                | [**ContextData**](/pt/api/context/)                     |             | Contexto da tela.                                                                                            |
