...
Depois que você viu que é possível realizar[ **Operações**](/pt/api/context/operations) do tipo soma, subtração, etc, utilizando o contexto, você também pode criar a sua própria operação na plataforma que você quiser:
