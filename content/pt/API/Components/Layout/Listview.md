...
| context            | [ContextData](/pt/api/context)                         |             | Define o contexto do componente.                                                                                                    |
| onInit             | List&lt;[Action](/pt/api/actions)&gt;                  |             | Lista de ações a serem executadas assim que o componente é exibido.                                                                 |
| dataSource         | [Bind](/pt/api/context#binding)&lt;List&lt;Any&gt;&gt; |      ✓      | Expressão que aponta para uma lista de valores usados para popular o componete.                                                     |
| template           | [ServerDrivenComponent](/pt/api/components)            |      ✓      | Representa cada celula na lista através de um `ServerDrivenComponent`.                                                              |
| onScrollEnd        | List&lt;[Action](/pt/api/actions)&gt;                  |             | Lista de ações executadas quando a lista chega ao fim.                                                                              |
