...
Por exemplo, um `PageView` pode ser declarado dentro de um [**Container**](/pt/api/components/layout/container) e sua largura e altura são responsáveis por determinar o tamanho do Page View.
{{% /alert %}}
