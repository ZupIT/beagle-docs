...
| :--- | :--- | :---: | :--- |
| route | ​[Route](/pt/api/ações/navigate/route/)​ | ✓ | Rota de navegação. |

## Como usar?

No exemplo abaixo, foram utilizadas três telas: as duas primeiras utilizam o [**PushView** ](/pt/api/ações/navigate/pushview)para adicionar as telas na pilha, já a última faz uso do **ResetApplication** e reabre na primeira tela.
