...
| :--- | :--- | :---: | :--- |
| url | String ou [Binding](/pt/api/contexto#binding) | ✓ | Define a página inicial que o Web View irá carregar. Ele deve ser declarado e não pode ser configurado como valor nulo.  |
