...
Agora você só precisa chamar a [**Action Navigate**](/pt/api/actions/navigate/) com o método [**OpenNativeRoute**](/pt/api/actions/navigate/opennativeroute) como o exemplo abaixo:
