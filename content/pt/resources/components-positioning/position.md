...
Esta propriedade determina a posição de um assume em tela e os seus valores `top, right, bottom, left` se comportam de acordo com o [**Position Type**]({{< ref path="/resources/posicionamento-de-componentes/positiontype" lang="pt" >}}) deste elemento.
