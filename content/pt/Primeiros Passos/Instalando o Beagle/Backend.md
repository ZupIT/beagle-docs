...
Para outras linguagens, seu servidor precisa servir o JSON seguindo nossa API. Dê uma olhada também na nossa implementação de [**cache**](/pt/recursos/cache/) e em [**mecanismos específicos de cada linguagem**](/pt/recursos/componentes/especificação-de-componentes-por-plataforma)
{{% /alert %}}
...
{{% alert color="warning" %}}
Se o seu time trabalha com microsserviços usando outros frameworks, acesse o [**framework do Beagle**](/pt/recursos/customização/beagle-para-backend/beagle-framework).  
{{% /alert %}}
...
Você pode conferir um **exemplo prático** de tela ou componente Server-Driven [**para testar o BFF**](/pt/primeiros-passos/usando-o-beagle/backend)
...
Você pode conferir um **exemplo prático** de [**como testar o Beagle no Backend**](/pt/primeiros-passos/usando-o-beagle/backend) ou componente Server-Driven para testar o BFF. 
...
👉Vá para as [**configurações iniciais**](/pt/primeiros-passos/usando-o-beagle/backend) para habilitar uso do Beagle no seu projeto Backend

👉 Se quiser ir direto para prática, acesse nosso [**tutorial para criar um projeto do zero**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-backend)
