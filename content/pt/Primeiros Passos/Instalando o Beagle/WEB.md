...
{{% alert color="success" %}}
Parabéns, a sua biblioteca está instalada! Veja agora [**como usar o Beagle no Angular**](/pt/primeiros-passos/usando-o-beagle/web/angular)
{{% /alert %}}
...
{{% alert color="success" %}}
Parabéns, a sua biblioteca está instalada! Veja agora [**como usar Beagle no React.**](/pt/primeiros-passos/usando-o-beagle/web/react)
{{% /alert %}}
...
👉Vá para as [**configurações iniciais**](/pt/primeiros-passos/usando-o-beagle/web/) para habilitar uso do Beagle no seu projeto Web

👉 Se quiser ir direto para prática, acesse nosso[ **tutorial para criar um projeto do zero**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-web)
