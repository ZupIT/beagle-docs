...
👉Vá para as [**configurações iniciais** ](/pt/primeiros-passos/usando-o-beagle/android)para habilitar uso do Beagle no seu projeto Android

👉 Se quiser ir direto para prática, acesse nosso [**tutorial para criar um projeto do zero**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-android/)
