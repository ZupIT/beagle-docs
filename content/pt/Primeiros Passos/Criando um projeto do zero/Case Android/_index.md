...
[**👉 Acesse Camada de rede:**](/pt/recursos/customização/beagle-para-android/camada-de-rede/)

[**👉 Acesse Gerenciar cache:**](/pt/recursos/customização/beagle-para-android/gerenciar-cache/)

[**👉 Acesse Sistema de log:**](/pt/recursos/customização/beagle-para-ios/sistema-de-log/)
...
[**Design System no Beagle para Android**.](/pt/primeiros-passos/criando-um-projeto-do-zero/case-android/design-system-com-beagle-android/) 
{{% /alert %}}
...
Tudo o que você precisa agora é [**configurar um backend** ](/pt/primeiros-passos/criando-um-projeto-do-zero/case-backend)para responder as requisições da sua aplicação. Feita esta configuração, inicie a sua aplicação e você verá sua primeira tela server-driven! 
