...
Como ponto de partida, siga nosso [**passo a passo para instalar o backend**](/pt/primeiros-passos/instalando-o-beagle/backend). 
...
👉 Tutorial do Beagle para [**Android**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-android/).

👉Tutorial do Beagle para [**iOS**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-ios).

👉Tutorial do Beagle para  [**Web**](/pt/primeiros-passos/criando-um-projeto-do-zero/case-web).
