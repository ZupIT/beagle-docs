...
- **strategy:** opcional. Mostra qual [**estratégia de cache**]({{< ref path="/web/commons/cache-strategy" lang="pt" >}}) deve ser usada para carregar uma view específica. E usará a configuração global caso não for especificado.
