...
Caso queira manter o estilo original de carregamento, basta executar a implementação padrão e seguir para o [**tratamento de erros**]({{< ref path="/ios/customization/loading-and-error-treatment" lang="pt" >}}).
