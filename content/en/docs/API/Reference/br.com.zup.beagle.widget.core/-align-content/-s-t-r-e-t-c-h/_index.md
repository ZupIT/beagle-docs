...
[beagle]({{< relref "../../../_index.md" >}}) / [br.com.zup.beagle.widget.core]({{< relref "../../_index.md" >}}) / [AlignContent]({{< relref "../_index.md" >}}) / [STRETCH]({{< relref "_index.md" >}}) / 
...
[name]({{< relref "_index.md#br.com.zup.beagle.widget.core/AlignContent.STRETCH/name/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [name]({{< relref "_index.md#br.com.zup.beagle.widget.core/AlignContent.STRETCH/name/#/PointingToDeclaration/" >}}): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)</b>   
...
[ordinal]({{< relref "_index.md#br.com.zup.beagle.widget.core/AlignContent.STRETCH/ordinal/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [ordinal]({{< relref "_index.md#br.com.zup.beagle.widget.core/AlignContent.STRETCH/ordinal/#/PointingToDeclaration/" >}}): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)</b>   
