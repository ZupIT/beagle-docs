...
{{% alert color="warning" %}}
After an important release, we'll probably launch versions with specific bug fixes for iOS, in which will have a version tag followed the suffix "-iOS" \(e.g: "1.0.1-iOS"\).
{{% /alert %}}
