...
One of the main advantages is that Beagles facilitates the development because of backend's configuration based on [**BFF paradigm.**](/docs/key-concepts#backend-for-frontend)
...
Yes! As a cross-platform framework, Beagle helps you on developing application on these three platforms by using the [**Server-Driven UI concept**](/docs/key-concepts#server-driven-ui), which enables that even a BFF may be used on all of these applications. 

You can see more how to create Beagle's projects with each of these platforms on: 

* [**Beagle for Android** ](/docs/get-started/creating-a-project-from-scratch/case-android/)
* [**Beagle for iOS**](/docs/get-started/creating-a-project-from-scratch/case-ios/)
* [**Beagle for Web**](/docs/get-started/creating-a-project-from-scratch/case-web)
