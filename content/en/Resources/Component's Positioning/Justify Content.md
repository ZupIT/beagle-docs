...
{{% alert color="danger" %}}
The size of a container can interfere on this property behaviour. When the elements are positioned, they can be set in a column instead a line, like the example below. If the container does not have enough height to contain all the stacked elements, this property won't be able to show the element in a column, 
{{% /alert %}}
