...
Beagle Web offers some cache strategies, one of them is the [**Beagle's pattern cache protocol guided by the backed**](/resources/cache#how-does-the-cache-protocol-works). 
