...
To learn how to create custom actions, check out Beagle's customization section of each platform ([Android]({{< ref path="android/customization" >}}), [iOS]({{< ref path="ios/customization" >}}), [Web]({{< ref path="web/commons" >}}).
