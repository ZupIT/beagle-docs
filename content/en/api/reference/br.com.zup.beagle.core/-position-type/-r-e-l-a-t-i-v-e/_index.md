...
[beagle]({{< relref "../../../_index.md" >}}) / [br.com.zup.beagle.core]({{< relref "../../_index.md" >}}) / [PositionType]({{< relref "../_index.md" >}}) / [RELATIVE]({{< relref "_index.md" >}}) / 
...
[name]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.RELATIVE/name/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [name]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.RELATIVE/name/#/PointingToDeclaration/" >}}): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)</b>   
...
[ordinal]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.RELATIVE/ordinal/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [ordinal]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.RELATIVE/ordinal/#/PointingToDeclaration/" >}}): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)</b>   
