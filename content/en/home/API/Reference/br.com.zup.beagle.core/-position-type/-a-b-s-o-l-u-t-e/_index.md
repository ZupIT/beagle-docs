...
[beagle]({{< relref "../../../_index.md" >}}) / [br.com.zup.beagle.core]({{< relref "../../_index.md" >}}) / [PositionType]({{< relref "../_index.md" >}}) / [ABSOLUTE]({{< relref "_index.md" >}}) / 
...
[name]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.ABSOLUTE/name/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [name]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.ABSOLUTE/name/#/PointingToDeclaration/" >}}): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)</b>   
...
[ordinal]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.ABSOLUTE/ordinal/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [ordinal]({{< relref "_index.md#br.com.zup.beagle.core/PositionType.ABSOLUTE/ordinal/#/PointingToDeclaration/" >}}): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)</b>   
