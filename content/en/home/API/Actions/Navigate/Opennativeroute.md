...
It opens a new screen through a [**deep link**](/pt/home/resources/customization/beagle-for-android/deep-link-handler)**.​**
...
{{% alert color="warning" %}}
You must configure a [**DeepLinkHandler**](/pt/home/resources/customization/beagle-for-android/deep-link-handler) in order to use this component.
{{% /alert %}}
...
To test this, configure [**Deep Link Handler**](/pt/home/resources/customization/beagle-for-android/deep-link-handler) for Android or **openNativeRoute** for iOS. Besides, your BFF's endpoint must return the code screen below and call it in the frontend.
