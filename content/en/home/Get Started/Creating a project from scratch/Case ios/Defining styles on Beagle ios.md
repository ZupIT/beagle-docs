...
On the first use example, you saw how to [**implement Beagle**](/pt/home/get-started/creating-a-project-from-scratch/case-ios) and create your first server-driven screen.

In this tutorial, the idea is to get deeper from the [**previous project**](/pt/home/get-started/creating-a-project-from-scratch/case-ios) to create a Design System on Beagle's library. To better illustrate the explanation, we'll use these [**sample codes**](https://github.com/ZupIT/beagle-examples) that you can find out in our repository.
...
This `struct` will contain all the styles Beagle will access. Here, it will be listed the logic that allows Beagle to apply defined styles on iOS into a [**server-driven screen**](/pt/home/key-concepts#server-driven-ui).
