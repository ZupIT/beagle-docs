...
- **strategy:** optional. Tells which [**cache strategy**](/home/resources/customization/beagle-for-web/cache-strategy) should be used to load this specific view. Will use the global configuration if not specified.
