...
{{% alert color="warning" %}}
The files `beagle.module.ts` and `beagle-components.module.ts` are automatically generated by Angular's library. If you haven't found it, [**check you installation**](/home/get-started/installing-beagle/).
{{% /alert %}}
{{% /tab %}}
{{< /tabs >}}
...
{{% alert color="warning" %}}
The files `beagle.module.ts` and `beagle-components.module.ts` are automatically generated by Angular's library. If you haven't found them, [**check your installation**](/home/get-started/installing-beagle/).
{{% /alert %}}
{{% /tab %}}
{{< /tabs >}}
