...
Currently in Beagle, the [**Container**](/pt/home/api/components/layout/container) and [**ListView**](/pt/home/api/components/layout/listview) components have the behavior of executing a list of actions as soon as they are rendered. For this, they expose the `onInit` property, which receives the list of actions that will be triggered.
...
{{% alert color="danger" %}}
It is mandatory to implement the `OnInitiableCompoent` interface for every custom widget that is inserted into the [ListView](/pt/home/api/components/layout/listview) component.
{{% /alert %}}
