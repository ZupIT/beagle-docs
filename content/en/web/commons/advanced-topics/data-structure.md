...
- `style` is the stylization rules for the component. These rules are not CSS, instead it's a **structure defined by Beagle** [Android]({{< ref path="android/customization/style" >}}), [iOS]({{< ref path="ios/customization/dependencies/style" >}}), [Web]({{< ref path="web/commons/styling" >}}).
