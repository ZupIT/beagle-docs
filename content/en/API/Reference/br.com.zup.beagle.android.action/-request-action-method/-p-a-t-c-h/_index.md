...
[beagle]({{< relref "../../../_index.md" >}}) / [br.com.zup.beagle.android.action]({{< relref "../../_index.md" >}}) / [RequestActionMethod]({{< relref "../_index.md" >}}) / [PATCH]({{< relref "_index.md" >}}) / 
...
[name]({{< relref "_index.md#br.com.zup.beagle.android.action/RequestActionMethod.PATCH/name/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [name]({{< relref "_index.md#br.com.zup.beagle.android.action/RequestActionMethod.PATCH/name/#/PointingToDeclaration/" >}}): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)</b>   
...
[ordinal]({{< relref "_index.md#br.com.zup.beagle.android.action/RequestActionMethod.PATCH/ordinal/#/PointingToDeclaration/" >}})
{{% /md %}}
</td>
<td>
{{% md %}}

  <b>override val [ordinal]({{< relref "_index.md#br.com.zup.beagle.android.action/RequestActionMethod.PATCH/ordinal/#/PointingToDeclaration/" >}}): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)</b>   
