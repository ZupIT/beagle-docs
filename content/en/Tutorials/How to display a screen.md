...
{{% tab name="iOS" %}}
To render a [**server-driven**](/key-concepts#server-driven-ui) screen, just create an instance **`BeagleScreenViewController`** and the type is **`remote`**, then you make the initialization with your [**BFF's URL**](/key-concepts#backend-for-frontend), like the example below:
