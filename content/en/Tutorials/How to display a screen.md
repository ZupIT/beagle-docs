...
In this example, you only call it BeagleActivity, but this name is defined by you when creating your BeagleActivity. In the tutorial [**Creating a project from scratch** ](/docs/get-started/creating-a-project-from-scratch/case-android), it is called `AppBeagleActivity`. 
{{% /alert %}}
...
For more details on this component click on the link below and check the [Remote View](/docs/resources/customization/beagle-for-web/remote-view-parameters).
{{% /alert %}}
