...
The method Set Id is used when you need to set an Id on a [**widget**](/api/widget) provided by the [**BFF**](/key-concepts#backend-for-frontend). To do so, you just have to call this method on the widget you want to set the Id during the moment you're creating your widget.
